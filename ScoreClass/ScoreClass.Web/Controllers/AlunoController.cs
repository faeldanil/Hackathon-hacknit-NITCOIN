...
namespace ScoreClass.Web.Controllers
{
    public class AlunoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Telefone")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Nome,Telefone")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
